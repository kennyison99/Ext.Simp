// Generated by scripts/build-downloader.mjs. Edit adapters/build script, not this file.
(async () => {
await window.citylinkGMReady;
window.GM_info.script.version = "3.22";
      ...
      `;
         ...
         */
          ...
          `;
                    ...
                    ui.tooltip(citylinkCreateOptionsButton(btnDownloadPost), configForm, {
                        trigger: 'click',
                        onShown: instance => {
...
(function () {
    ...
    citylinkOnReady(async () => {


        try {
            const { source, status } = await h.http.get('https://api.redgifs.com/v2/auth/temporary', {}, { __xfpd_timeout: 5000 }, 'text');
        ...
        if (parsedPosts.filter(p => p.parsedHosts.length).length > 0) {
            ...
            ui.tooltip(citylinkCreateOptionsButton(btnDownloadPage), ui.forms.config.page.createForm(color, html), {
                trigger: 'click',
                placement: 'bottom',
                interactive: true,
                onShown: () => {
